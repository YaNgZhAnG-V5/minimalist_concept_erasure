...
class FluxPipelineForSLB(FluxPipeline):
    ...
    def __call__(
        ...
        sld_warmup_steps: Optional[int] = 1,
        ...
        (
            ...
            prompt=[prompt, "", self.safety_concept],
            prompt_2=prompt_2,
            prompt_embeds=prompt_embeds,
            pooled_prompt_embeds=pooled_prompt_embeds,
            device=device,
        ...
        # prompt embeds for safety concept
        # prompt, unconditional, safety concept
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred_text, noise_pred_uncond, noise_pred_safety_concept = noise_pred.chunk(3)
                ...
                # calculate the scale factor between text prompt and safety concept
                scale = torch.clamp(
                ...
                if i >= sld_warmup_steps:  # Warmup steps
